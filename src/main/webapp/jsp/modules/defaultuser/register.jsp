...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/normalize.css">
...
<body>
	...
	<div class="login">
		...
		<form method="post" id="registerForm">
			<input type="text" name="gonghao" placeholder="工号" /> <input
				type="text" name="mima" placeholder="密码" /> <input type="text"
				name="xingming" placeholder="姓名" /> <input type="text"
				name="shouji" placeholder="手机" /> <input type="text"
				name="youxiang" placeholder="邮箱" />

			<button type="button" id="submitBtn"
				class="btn btn-primary btn-block btn-large">注册</button>
		</form>
	</div>
	<script
