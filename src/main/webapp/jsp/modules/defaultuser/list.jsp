...
<body>
				...
				<div class="page-inner"
					...
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">注册用户信息</a></li>
						</ul>
					</div>
												...
												<div class="col-sm-12">
													<div id="add-row_filter" class="dataTables_filter">
														<label>用户名<input type="text" id="usernameSearch"
															...
															aria-controls="add-row"></label> <label>姓名 <input
															type="text" id="nameSearch"
															class="form-control form-control-sm" placeholder=""
															aria-controls="add-row"></label> <label>性别</label> <select
															name="sex" id="xingbieSelect">
															<option value=" "></option>
														...
														<thead>
															...
															<tr role="row">
																...
																<th id="usernameTh" class="sorting"
																	...
																	aria-controls="add-row" rowspan="1" colspan="1">用户名</th>
																<th id="mimaTh" class="sorting" onclick="sort('mima')"
																	tabindex="0" aria-controls="add-row" rowspan="1"
																	colspan="1">密码</th>
																<th id="nameTh" class="sorting"
																	onclick="sort('name')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">姓名</th>
																<th id="sexTh" class="sorting"
																	onclick="sort('sex')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">性别</th>
																<th id="ageTh" class="sorting"
																	onclick="sort('age')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">年龄</th>
																<th id="phoneTh" class="sorting"
																	onclick="sort('phone')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">手机</th>
																<th id="emailTh" class="sorting"
																	onclick="sort('email')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">邮箱</th>

																<th tabindex="0" aria-controls="add-row" rowspan="1"
																	colspan="1" style="min-width: 100px;">照片</th>
																<th id="addtimeTh" class="sorting"
																	onclick="sort('addtime')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">创建时间</th>
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function setDataRow(item) {
			...
			var zhaopianImgUrl = baseUrl + 'upload/' + item.picture;
			zhaopianImg.setAttribute('src', zhaopianImgUrl);
