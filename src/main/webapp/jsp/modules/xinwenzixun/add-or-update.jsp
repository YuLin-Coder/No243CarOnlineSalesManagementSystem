...
<body>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a
								href="${pageContext.request.contextPath}/jsp/modules/news/list.jsp">新闻资讯</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										<div class="col-md-6 col-lg-4">
											<form id="addOrUpdateForm" method="post">
												...
												<div class="form-group">
													<label>图片</label> <img id="pictureImg" src="" width="100"
														height="100"> <input name="file" type="file"
														id="pictureupload" class="form-control-file"> <input
												...
												<div class="form-group">
													<label>内容</label> <input id="contentupload" name="file"
														type="file">
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		// 填充富文本框
		function setContent() {
			if (ruleForm.content != null && ruleForm.content != 'null'
					&& ruleForm.content != '') {
		...
		function getContent() {
			if (UE.getEditor('contentEditor').hasContents()) {
				$('#content-input').attr('value',
						UE.getEditor('contentEditor').getPlainTxt());
			}
		}
		// 表单校验
		function validform() {
