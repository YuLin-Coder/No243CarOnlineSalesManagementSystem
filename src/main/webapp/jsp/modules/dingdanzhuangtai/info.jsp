									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="yunshufeiyong" v-model="ruleForm.yunshufeiyong" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>预计送达</label>
																								
																								<input id="yujisongda" v-model="ruleForm.yujisongda" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>订单状态</label>
																								
																								<input id="dingdanzhuangtai" v-model="ruleForm.dingdanzhuangtai" readonly>
																							</div>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dingdanzhuangtai/info/" + id,
