				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/dingdanzhuangtai/list.jsp">订单状态</a>
							</li>
						</ul>
					</div>
					<div class="row">
									...
									<div class="row">
										...
										<form id="addOrUpdateForm" method="post">
											...
											<div class="form-group">
												...
												<input id="yujisongda" name="yujisongda" class="form-control" placeholder="预计送达">
												</div>	
											<div class="form-group">
												<label>订单状态</label>
												...
												<select id="dingdanzhuangtaiSelect" name="dingdanzhuangtai" class="form-control">
															<option value=" "></option>
																...
																未发货
																	...
																	<option class="dingdanzhuangtaiOption" value="已发货">
																已发货
															</option>
																	<option class="dingdanzhuangtaiOption" value="运输中">
																运输中
															</option>
																	<option class="dingdanzhuangtaiOption" value="已送达">
																已送达
															</option>
																	<option class="dingdanzhuangtaiOption" value="已验收">
																已验收
															</option>
																	<option class="dingdanzhuangtaiOption" value="订单完成">
																订单完成
															</option>
															</select>
												</div>	
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dingdanzhuangtai/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				...
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("dingdanzhuangtai/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						setSelectOption();
						// 设置图片src
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#zhanghao").val(ruleForm.zhanghao);	
																...
																$("#yujisongda").val(ruleForm.yujisongda);	
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.yujisongda != null && res.data.yujisongda != ''){
															...
															$("#yujisongda").val(res.data.yujisongda);
													}
