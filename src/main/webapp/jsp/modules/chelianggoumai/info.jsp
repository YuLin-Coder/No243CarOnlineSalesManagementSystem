									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="cheliangbianhao" v-model="ruleForm.cheliangbianhao" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆名称</label>
																								
																								<input id="cheliangmingcheng" v-model="ruleForm.cheliangmingcheng" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆品牌</label>
																								
																								<input id="cheliangpinpai" v-model="ruleForm.cheliangpinpai" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆类型</label>
																								
																								<input id="cheliangleixing" v-model="ruleForm.cheliangleixing" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆颜色</label>
																								
																								<input id="cheliangyanse" v-model="ruleForm.cheliangyanse" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>换挡方式</label>
																								
																								<input id="huandangfangshi" v-model="ruleForm.huandangfangshi" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆天窗</label>
																								
																								<input id="cheliangtianchuang" v-model="ruleForm.cheliangtianchuang" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>汽车排量</label>
																								
																								<input id="qichepailiang" v-model="ruleForm.qichepailiang" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车座</label>
																								
																								<input id="chezuo" v-model="ruleForm.chezuo" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>车辆价格</label>
																								
																								<input id="cheliangjiage" v-model="ruleForm.cheliangjiage" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>订购数量</label>
																								
																								<input id="dinggoushuliang" v-model="ruleForm.dinggoushuliang" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shouhuodizhi" v-model="ruleForm.shouhuodizhi" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>订购时间</label>
																								
																								<input id="dinggoushijian" v-model="ruleForm.dinggoushijian" readonly>
																							</div>
