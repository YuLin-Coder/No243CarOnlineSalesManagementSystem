...
<body>
				...
				<div class="page-inner"
					...
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">试卷管理</a></li>
						</ul>
					</div>
													...
													<table id="add-row"
														...
														<thead>
															...
															<tr role="row">
																...
																<th id="timeTh" class="sorting"
																	onclick="sort('time')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">考试时长</th>
																<th id="statusTh" class="sorting"
																	onclick="sort('status')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">试卷状态</th>
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function setDataRow(item) {
			...
			if(item.status == 1){
				statusCell.innerHTML = "<button class=\"btn btn-xs btn-success\" disabled>启用</button>";
			}else if(item.status == 0){
				statusCell.innerHTML = "<button class=\"btn btn-xs btn-secondary\" disabled>禁用</button>";
			}		
