				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="${pageContext.request.contextPath}/jsp/modules/chukujilu/list.jsp">出库记录</a>
							</li>
						</ul>
					</div>
					<div class="row">
	...
	<script>
       ...
       //跨表
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.cheliangkucun != null && res.data.cheliangkucun != ''){
															...
															cheliangkucunKucun = res.data.cheliangkucun;
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
																																																																									cheliangkucun: crossRuleForm.cheliangkucun - $('#cheliangkucun').val(),	
																										},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
		...
		function crossTableUpdateValidation(){
			//防止减法导致库存负值
																																															if(cheliangkucunKucun < $('#cheliangkucun').val()){
						alert('车辆库存不能大于'+cheliangkucunKucun+'！请重新输入');
						return false;
					}
																	return true;
		}
