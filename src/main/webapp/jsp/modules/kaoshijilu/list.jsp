				...
				<div class="page-inner"
					...
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item"><a href="#">考试记录</a></li>
						</ul>
					</div>
												...
												<div class="col-sm-12">
													<div id="add-row_filter" class="dataTables_filter">
														<label>试卷 <input type="text" id="papernameSearch"
															...
															aria-controls="add-row"></label> <label>试题名称 <input
													...
													<table id="add-row"
														...
														<thead>
															...
															<tr role="row">
																...
																<th id="idTh" class="sorting"
																	onclick="sort('id')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">用户</th>
																<th id="papernameTh" class="sorting"
																	onclick="sort('papername')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">试卷</th>
																<th id="questionnameTh" class="sorting"
																	onclick="sort('questionname')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">试题名称</th>
																<th id="scoreTh" class="sorting"
																	onclick="sort('score')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">分值</th>
																<th id="answerTh" class="sorting"
																	onclick="sort('answer')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">正确答案</th>
																<th id="myanswerTh" class="sorting"
																	onclick="sort('myanswer')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">考生答案</th>
																<th id="myscoreTh" class="sorting"
																	onclick="sort('myscore')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">考生分值</th>
																<th id="addtimeTh" class="sorting"
																	onclick="sort('addtime')" tabindex="0"
																	aria-controls="add-row" rowspan="1" colspan="1">考试时间</th>		
