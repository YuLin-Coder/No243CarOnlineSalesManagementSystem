...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">车辆信息评论表统计</h4>
	...
	<script >
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/discusscheliangxinxi/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/discusscheliangxinxi/"+colName,
             	data:{	tableName: "discusscheliangxinxi",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
