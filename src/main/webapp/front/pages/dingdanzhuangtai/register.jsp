	...
	<body style="background: #EEEEEE; ">
		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="shifujine" name="shifujine" placeholder="请输入实付金额" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">运输费用：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="yunshufeiyong" name="yunshufeiyong" placeholder="请输入运输费用" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                <div class="layui-form-item layui-form-text">
					<label class="layui-form-label">预计送达：</label>
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="yujisongda" name="yujisongda" placeholder="请输入预计送达" autocomplete="off" class="layui-input">
					</div>
				</div>
