				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="shifujine" id="shifujine" placeholder="实付金额" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">运输费用</label>
							<div class="layui-input-block">
								<input type="text" name="yunshufeiyong" id="yunshufeiyong" placeholder="运输费用" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">预计送达</label>
							<div class="layui-input-block">
								<input type="text" name="yujisongda" id="yujisongda" placeholder="预计送达" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
