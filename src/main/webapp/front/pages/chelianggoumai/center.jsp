					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="cheliangbianhao" id="cheliangbianhao" placeholder="车辆编号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="cheliangpinpai" id="cheliangpinpai" placeholder="车辆品牌" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">车辆类型</label>
							<div class="layui-input-block">
								<input type="text" name="cheliangleixing" id="cheliangleixing" placeholder="车辆类型" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">车辆颜色</label>
							<div class="layui-input-block">
								<input type="text" name="cheliangyanse" id="cheliangyanse" placeholder="车辆颜色" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">换挡方式</label>
							<div class="layui-input-block">
								<input type="text" name="huandangfangshi" id="huandangfangshi" placeholder="换挡方式" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">车辆天窗</label>
							<div class="layui-input-block">
								<input type="text" name="cheliangtianchuang" id="cheliangtianchuang" placeholder="车辆天窗" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="chezuo" id="chezuo" placeholder="车座" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dinggoushuliang" id="dinggoushuliang" placeholder="订购数量" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dinggoushijian" id="dinggoushijian" placeholder="订购时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
