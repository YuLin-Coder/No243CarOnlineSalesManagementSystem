				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>车辆类型：</span>
							<span class="desc">
								{{detail.cheliangleixing}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>车辆颜色：</span>
							<span class="desc">
								{{detail.cheliangyanse}}
							</span>
						</div>
																								<div class="detail-item">
							<span>换挡方式：</span>
							...
							<span>车辆价格：</span>
							<span class="desc">
								{{detail.cheliangjiage}}
							</span>
						</div>
																								<div class="detail-item">
							<span>车辆库存：</span>
							<span class="desc">
								{{detail.cheliangkucun}}
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('cheliangxinxi','入库')" @click="onAcrossTap('rukujilu')" type="button" class="layui-btn">
								入库
							</button>
																					<button v-if="isAuth('cheliangxinxi','出库')" @click="onAcrossTap('chukujilu')" type="button" class="layui-btn">
								出库
							</button>
																					<button v-if="isAuth('cheliangxinxi','订购')" @click="onAcrossTap('chelianggoumai')" type="button" class="layui-btn">
								订购
							</button>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.cheliangmingcheng;
																																								// 轮播图片
					vue.swiperList = vue.detail.qichetupian ? vue.detail.qichetupian.split(",") : [];
																																																																																																																			var swiperItemHtml = '';
