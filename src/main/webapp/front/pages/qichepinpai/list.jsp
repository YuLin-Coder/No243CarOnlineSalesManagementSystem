		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('qichepinpai','新增')" @click="jump('../qichepinpai/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../qichepinpai/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
