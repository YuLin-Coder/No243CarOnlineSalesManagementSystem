		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
						...
						<div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
							...
							<button v-if="isAuth('storeup','新增')" @click="jump('../storeup/add.jsp')" type="button" class="layui-btn btn-theme">
				...
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../storeup/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" v-bind:key="index"
